"""
Ingresar una cadena de texto que solo acepte de tipo string y no acepte numeros.
...
# Verificar que la entrada no esté vacía, sea de tipo string y no contenga números
